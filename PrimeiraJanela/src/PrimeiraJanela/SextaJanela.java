...
public class SextaJanela extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SextaJanela.class.getName());

    // ✅ Variável que guarda a pontuação atual
    private int pontuacao;

    // ✅ Construtor agora recebe a pontuação vinda da janela anterior
    public SextaJanela(int pontuacao) {
    ...
    // Resposta ERRADA - 10 minutos
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(null, "Você Errou!!\nA resposta certa era: 8 minutos", "Errou!", JOptionPane.WARNING_MESSAGE);
        setVisible(false);
        // ✅ Passa a pontuação SEM somar (errou)
        QuintaJanela janela = new QuintaJanela(pontuacao);
        janela.setVisible(true);
    }

    // Resposta ERRADA - 12 minutos
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SextaJanela(0).setVisible(true));
    }
