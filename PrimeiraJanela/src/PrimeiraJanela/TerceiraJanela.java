...
public class TerceiraJanela extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TerceiraJanela.class.getName());

    // ✅ Variável que guarda a pontuação atual
    private int pontuacao;

    // ✅ Construtor agora recebe a pontuação vinda da janela anterior
    public TerceiraJanela(int pontuacao) {
    ...
    // Resposta ERRADA - França
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(null, "Você Errou!!\nA resposta certa era: Brasil", "Errou!", JOptionPane.WARNING_MESSAGE);
        setVisible(false);
        // ✅ Passa a pontuação SEM somar (errou)
        QuartaJanela janela = new QuartaJanela(pontuacao);
        janela.setVisible(true);
    }

    // Resposta CERTA - Brasil
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TerceiraJanela(0).setVisible(true));
    }
